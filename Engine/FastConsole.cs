...
public static class FConsole {
    ...
    public static void SetChar(int x, int y, char c, ConsoleColor foreground, ConsoleColor background, bool overline = false, bool leftline = false, bool rightline = false, bool underline = false) {
        SetChari(x, y, c, foreground, background, overline, leftline, rightline, underline);
    }
    public static void SetChari(int x, int y, char c, ConsoleColor foreground, ConsoleColor background, bool overline = false, bool leftline = false, bool rightline = false, bool underline = false) {
